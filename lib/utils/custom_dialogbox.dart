          ...
          child: Container(
            ...
            child:  Column(
              ...
              children: [
                ...
                //       fontSize: 20),
                // ),
                Image.asset('assets/images/popup/app_logo_black.png',height: 120,width: 40.w,),
                Spacer(),
                Padding(
                  padding: EdgeInsets.symmetric(
                      horizontal: 15),
                    ...
                    child: Container(
                        ...
                        child: Center(
                          child: Text(buttonText??'Back',
                              style: TextStyle().copyWith(color: AppColors.buttonTextColor,fontWeight: FontWeight.w600,fontSize: 16)),
                        )),
                  ),
                ),
                const SizedBox(
