...
import 'package:beauty_connect/guest_mode/widgets/text_form_fields.dart';
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  title,
                  style:
                      headingLarge.copyWith(color: AppColors.whiteColor, fontSize: 22,),
              ...
              Padding(
                ...
                child: Text(
                  desc,
                  style: authSubHeading.copyWith(fontSize: 12, height: 1.5,color: AppColors.whiteColor),
                  textAlign: TextAlign.center,
                ),
              ),
              const SizedBox(
