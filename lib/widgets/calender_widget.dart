import 'package:beauty_connect/widgets/status_tag.dart';
        ...
        calendarBuilders: CalendarBuilders(
          ...
          defaultBuilder: (context, date, events) {
            return Container(
              margin: EdgeInsets.all(4),
              decoration: BoxDecoration(
                color: Colors.grey.withOpacity(0.2), // Set unselected day background color
                borderRadius: BorderRadius.circular(100.0),
              ),
              child: Center(
                child: Text(
                  date.day.toString(),
                  style: bodyMedium.copyWith(color: Colors.white), // Set unselected day text color
                ),
              ),
            );
          },
