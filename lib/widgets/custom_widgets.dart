import 'package:beauty_connect/guest_mode/constants/custom_dialog.dart';
...
class CustomButton extends StatefulWidget {
 ...
 final FontWeight? fontWeight;
  const CustomButton(
      ...
      this.buttonText,
      required this.onTap,
      this.buttonClr = AppColors.buttonColor, this.textClr = Colors.white, this.fontSize = 14,this.fontWeight})
      : super(key: key);
